...
abootimg --create boot-db410c.img -k Image.gz+dtb -r initrd.img-4.9.27-linaro-lt-qcom \
           -c pagesize=2048 -c kerneladdr=0x80008000 -c ramdiskaddr=0x81000000 \
	   -c cmdline="root=/dev/disk/by-partlabel/rootfs rw rootwait console=ttyMSM0,115200n8"
