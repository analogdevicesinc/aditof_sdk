...
browserify network/network.js network/network_sensor_enumerator.js network/network_depth_sensor.js  network/network_storage.js  network/network_temperature_sensor.js sdk/system.js sdk/camera.js sdk/frame.js -o bundle.js
