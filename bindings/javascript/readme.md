## JavaScript bindings are still not completely functional. This is work in progress.
...
Enter the IP address of the 3D Smart Camera and press the button "Connect to the camera".
