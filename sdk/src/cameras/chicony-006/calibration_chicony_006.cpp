...
static const char *EEPROM_REPLACEMENT_PATH =
    "/home/toybrick/workspace/github/aditof_sdk/chicony_firmware.bin";
...
aditof::Status CalibrationChicony006::setMode(const std::string &mode) {
    ...
    status =
        readEeprom(0xFFFFFFFE, reinterpret_cast<uint8_t *>(&firmwareLength),
...
aditof::Status CalibrationChicony006::readEeprom(uint32_t address,
    ...
    case (0xFFFFFFFF): {
        std::ifstream firmware_file(EEPROM_REPLACEMENT_PATH, std::ios::binary);
